const s = ( sketch ) => {
    ...
    sketch.setup = () => {
        ...
        // Drawing canvas
        canvasWidth = sketch.displayWidth-canvasDistX*2;
        canvasHeight = sketch.displayHeight-canvasDistY*3+canvasDistX;
        ...
        sketch.rect(width - closeButtonSize - buttonDist + shadowDist, buttonDist + shadowDist, closeButtonSize);
        // Button
        sketch.fill(white);
        sketch.stroke(black);
        sketch.strokeWeight(2);
        sketch.rect(width - closeButtonSize - buttonDist, buttonDist, closeButtonSize);
        // X icon
        sketch.line(width - closeButtonSize - buttonDist + 5, buttonDist + 5, sketch.width - buttonDist - 5, buttonDist + closeButtonSize - 5)
        sketch.line(width - buttonDist - 5, buttonDist + 5, sketch.width - closeButtonSize - buttonDist + 5, buttonDist + closeButtonSize - 5)
        ...
        // Eraser icon
        sketch.rotate(PI/4);
        sketch.rect(canvasDistX + 2.68*buttonSize + 2 * buttonDist, canvasDistY - 2 * buttonDist - 3.73*buttonSize, 9, 18);
        sketch.fill(black);
        sketch.rect(canvasDistX + 2.68*buttonSize + 2 * buttonDist, canvasDistY - 2 * buttonDist - 3.73*buttonSize, 9, 12);
        sketch.rotate(-PI/4);
        ...
        sketch.noStroke();
        sketch.fill(shadowColor);
        sketch.rect(width - buttonSize*7 - buttonDist*10 - canvasDistX + shadowDist,  canvasDistY - buttonDist - buttonSize + shadowDist, buttonSize);
        // Button
        sketch.fill(white);
        sketch.stroke(black);
        sketch.strokeWeight(2);
        sketch.rect(width - buttonSize*7 - buttonDist*10 - canvasDistX, canvasDistY - buttonDist - buttonSize, buttonSize);
        // Line icon
        sketch.strokeWeight(4);
        sketch.line(width - buttonSize*7 - buttonDist*10 - canvasDistX + 8, canvasDistY - buttonDist - 1*buttonSize/2, sketch.width - buttonSize*6 - buttonDist*10 - canvasDistX - 8, canvasDistY - buttonDist - 1 * buttonSize/2)
        
        // Circle Button
        // Shadow
        sketch.noStroke();
        sketch.fill(shadowColor);
        sketch.rect(width - buttonSize*6 - buttonDist*9 - canvasDistX + shadowDist,  canvasDistY - buttonDist - buttonSize + shadowDist, buttonSize);
        // Button
        sketch.fill(white);
        sketch.stroke(black);
        sketch.strokeWeight(2);
        sketch.rect(width - buttonSize*6 - buttonDist*9 - canvasDistX, canvasDistY - buttonDist - buttonSize, buttonSize);
        // Circle icon
        sketch.fill(black);
        sketch.circle(width - 11 * buttonSize/2 - buttonDist * 9 - canvasDistX, canvasDistY - buttonDist - 1 * buttonSize/2, buttonSize - 2 * 8);
        
        // Square Button
        // Shadow
        sketch.noStroke();
        sketch.fill(shadowColor);
        sketch.rect(width - buttonSize*5 - buttonDist*8 - canvasDistX + shadowDist,  canvasDistY - buttonDist - buttonSize + shadowDist, buttonSize);
        // Button
        sketch.fill(white);
        sketch.stroke(black);
        sketch.strokeWeight(2);
        sketch.rect(width - buttonSize*5 - buttonDist*8 - canvasDistX, canvasDistY - buttonDist - buttonSize, buttonSize);
        // Square icon
        sketch.fill(black);
        sketch.rect(width - buttonSize*5 - buttonDist*8 - canvasDistX + 8, canvasDistY - buttonDist - buttonSize + 8, buttonSize - 2*8);
        
        // Triangle Button
        // Shadow
        sketch.noStroke();
        sketch.fill(shadowColor);
        sketch.rect(width - buttonSize*4 - buttonDist*7 - canvasDistX + shadowDist,  canvasDistY - buttonDist - buttonSize + shadowDist, buttonSize);
        // Button
        sketch.fill(white);
        sketch.stroke(black);
        sketch.strokeWeight(2);
        sketch.rect(width - buttonSize*4 - buttonDist*7 - canvasDistX, canvasDistY - buttonDist - buttonSize, buttonSize);
        // Triangle icon
        sketch.fill(black);
        sketch.triangle(width - buttonSize*4 - buttonDist*7 - canvasDistX + 8, canvasDistY - buttonDist - 8, sketch.width - canvasDistX - buttonSize*3 - buttonDist*7 - 8, canvasDistY - buttonDist - 8, sketch.width - 7*buttonSize/2 - buttonDist*7 - canvasDistX, canvasDistY - buttonDist - buttonSize + 8)
        
        // Slash Button
        // Shadow
        sketch.noStroke();
        sketch.fill(shadowColor);
        sketch.rect(width - buttonSize*3 - buttonDist*6 - canvasDistX + shadowDist,  canvasDistY - buttonDist - buttonSize + shadowDist, buttonSize);
        // Button
        sketch.fill(white);
        sketch.stroke(black);
        sketch.strokeWeight(2);
        sketch.rect(width - buttonSize*3 - buttonDist*6 - canvasDistX, canvasDistY - buttonDist - buttonSize, buttonSize);
        // \ icon
        sketch.strokeWeight(3);
        sketch.line(width - buttonSize*3 - buttonDist*6 - canvasDistX + 12, canvasDistY - buttonDist - buttonSize + 8, sketch.width - canvasDistX - buttonSize*2 - buttonDist*6 - 12, canvasDistY - buttonDist - 8)
        
        // + Button
        // Shadow
        sketch.noStroke();
        sketch.fill(shadowColor);
        sketch.rect(width - buttonSize*2 - buttonDist - canvasDistX + shadowDist,  canvasDistY - buttonDist - buttonSize + shadowDist, buttonSize);
        // Button
        sketch.fill(white);
        sketch.stroke(black);
        sketch.strokeWeight(2);
        sketch.rect(width - buttonSize*2 - buttonDist - canvasDistX, canvasDistY - buttonDist - buttonSize, buttonSize);
        // + icon
        sketch.strokeWeight(3);
        sketch.line(width - buttonSize*2 - buttonDist - canvasDistX + 8, canvasDistY - buttonDist - 1*buttonSize/2, sketch.width - canvasDistX - buttonSize - buttonDist - 8, canvasDistY - buttonDist - 1*buttonSize/2)
        sketch.line(width - 3*buttonSize/2 - buttonDist - canvasDistX, canvasDistY - buttonDist - buttonSize + 8, sketch.width - 3*buttonSize/2 - buttonDist - canvasDistX, canvasDistY - buttonDist - 8)
        
        // - Button
        // Shadow
        sketch.noStroke();
        sketch.fill(shadowColor);
        sketch.rect(width - buttonSize - canvasDistX + shadowDist,  canvasDistY - buttonDist - buttonSize + shadowDist, buttonSize);
        // Button
        sketch.fill(white);
        sketch.stroke(black);
        sketch.strokeWeight(2);
        sketch.rect(width - buttonSize - canvasDistX, canvasDistY - buttonDist - buttonSize, buttonSize);
        // - icon
        sketch.strokeWeight(3);
        sketch.line(width - buttonSize - canvasDistX + 10, canvasDistY - buttonDist - 1*buttonSize/2, sketch.width - canvasDistX - 10, canvasDistY - buttonDist - 1*buttonSize/2)
    ...
    sketch.mouseDragged = () => {
        // paint!
        if (sketch.mouseX > canvasDistX + brushSize/2 && sketch.mouseX < sketch.width - canvasDistX - brushSize/2 && sketch.mouseY > canvasDistY + brushSize/2 && sketch.mouseY < canvasDistY + canvasHeight - brushSize/2) {
    ...
    sketch.mousePressed = () => {
        ...
        // Picking colors
        for (i = 0; i < 12; i++) {
            if (sketch.mouseX >= canvasDistX + colorBoxSize*i + colorBoxDist*(i) && sketch.mouseX <= canvasDistX + colorBoxSize*(i+1) + colorBoxDist*(i) && sketch.mouseY >= canvasDistY + canvasHeight + canvasDistX && sketch.mouseY <= canvasDistY + canvasHeight + canvasDistX + colorBoxSize) {
                setColor(colors[i]);
